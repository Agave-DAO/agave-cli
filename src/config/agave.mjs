...
export default {
    ...
    LendingPoolConfigurator: {
        ...
        signatures: {
            ...
            configureReserveAsCollateral: 'configureReserveAsCollateral(address asset,uint256,uint256,uint256)',
            ...
            setReserveInterestRateStrategyAddress: 'setReserveInterestRateStrategyAddress(address,address)',
    ...
    LendingPoolAddressesProvider: {
        ...
        signatures: {
            ...
            setLendingPoolConfiguratorImpl: 'setLendingPoolConfiguratorImpl(address)',
            setLendingPoolCollateralManager: 'setLendingPoolCollateralManager(address)',
    ...
    LendingPoolAddressesProviderRegistry: {
        ...
        signatures: {
            registerAddressesProvider: 'registerAddressesProvider(address,uint256)',
