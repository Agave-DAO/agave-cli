...
const lendingPoolMenu = async () => {
    ...
    switch(result.lendingPool){
        ...
        case 'configureReserveAsCollateral':
            selection = await inquirer.prompt(prompts.lendingPool.configureReserveAsCollateral)
            // TODO:
            console.log('handeling..', selection)   
            break
        ...
        case 'disableBorrowingOnReserve':
            selection = await inquirer.prompt(prompts.lendingPool.disableBorrowingOnReserve)
            // TODO:
            console.log('handeling..', selection)   
            break
        case 'disableReserveStableRate':
            selection = await inquirer.prompt(prompts.lendingPool.disableReserveStableRate)
            // TODO:
            console.log('handeling..', selection)   
            break
        case 'enableBorrowingOnReserve':
            selection = await inquirer.prompt(prompts.lendingPool.enableBorrowingOnReserve)
            // TODO:
            console.log('handeling..', selection)   
            break
        case 'enableReserveStableRate':
            selection = await inquirer.prompt(prompts.lendingPool.enableReserveStableRate)
            // TODO:
            console.log('handeling..', selection)   
            break
        case 'freezeReserve':
        ...
        case 'setReserveInterestRateStrategyAddress':
            selection = await inquirer.prompt(prompts.lendingPool.setReserveInterestRateStrategyAddress)
            // TODO:
            console.log('handeling..', selection)   
            break
        ...
        case 'updateVariableDebtToken':
            selection = await inquirer.prompt(prompts.lendingPool.updateVariableDebtToken)
            // TODO:
            console.log('handeling..', selection)   
            break
        case 'updateStableDebtToken':
            selection = await inquirer.prompt(prompts.lendingPool.updateStableDebtToken)
            // TODO:
            console.log('handeling..', selection)   
            break
    }
